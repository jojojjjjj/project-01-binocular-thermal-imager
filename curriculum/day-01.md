...
热成像技术在现实生活中应用极为广泛：疫情期间的体温筛查、工业设备的故障检测、消防救援中的搜救定位、建筑节能检测等，都依赖红外热成像技术。你将要构建的这个小设备，其核心原理与价值<!-- 数万元 -->的专业热像仪完全相同。通过这个项目，你将掌握从硬件到软件的完整嵌入式系统开发流程，这是进入物联网、智能制造、机器人等前沿领域的基础技能。
